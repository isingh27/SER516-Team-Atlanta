...
# Function to retrieve project task statuses for a
# specific project from the Taiga API
def get_project_task_status_name(project_id, auth_token):
    # Get Taiga API URL from environment variables
    taiga_url = os.getenv('TAIGA_URL')

    # Construct the URL for the project task statuses API
    # endpoint for the specified project
    ...
    try:
        ...
        # Extract and return the project task statuses
